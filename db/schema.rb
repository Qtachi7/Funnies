...
ActiveRecord::Schema[8.1].define(version: 2026_03_04_033038) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.integer "cry_count", default: 0, null: false
    ...
    t.string "source"
    t.integer "surprised_count", default: 0, null: false
    t.string "title"
    t.datetime "updated_at", null: false
  ...
  create_table "reactions", force: :cascade do |t|
    ...
    t.index ["user_id", "post_id", "kind"], name: "index_reactions_on_user_id_and_post_id_and_kind", unique: true
